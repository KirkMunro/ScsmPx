        ...
        try {
            foreach ($item in $InputObject) {
                ...
                if ($PSCmdlet.ShouldProcess(($ShouldProcessArguments.Description -f $item.DisplayName), 'Confirm', ($ShouldProcessArguments.Warning -f $item.DisplayName))) {
                    $item.ObjectStatus = $item.__EnterpriseManagementObject.ManagementGroup.EntityTypes.GetEnumeration('acdcedb7-100c-8c91-d664-4629a218bd94')
                }
...
Export-ModuleMember -Function Restore-ScsmPxObject
# SIG # Begin signature block
# MIIZKQYJKoZIhvcNAQcCoIIZGjCCGRYCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUqnjFUbC+Ec7XVYh/x3Y+0k28
# SJigghQZMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# AQkEMRYEFC6jyFxsh/7Qg66JPgy9YdaZsMoeMA0GCSqGSIb3DQEBAQUABIIBAMgA
# Cf8JEYWxRM2UiOXgTr4bag5PQcyRgU85dybBcuHDvdU2lxAlpCeoSkOKHfhe1Dw9
# cXr87so+2HurK4cld/PmfuXtMGvzLJKo9SQIyb4G99ZgGyS21StqPaD8w49PoFN2
# 7KZRL/cir0NHWKHW3qQ7tAgX4n6rm5N1gz5ahlxDmBR+T/b/6k8qnDUNDDgZTBLz
# rGul7t0FmP+UECBgu3Eo176Mj2gvZeRsaVVIfeX9N7QNoxMpkirW+Hs/aw4RlYHb
# PRjx2X3xFPqJaO2rCw7RW55LTNbFGOce6+5hSdXz9oFOLDAO58ZHheCg7WFgbSrq
# Zam3rWyV+htXLgJsSiShggILMIICBwYJKoZIhvcNAQkGMYIB+DCCAfQCAQEwcjBe
...
# SIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMTYwMTIxMDIyNDEzWjAjBgkqhkiG9w0B
# CQQxFgQUWT124tYeadtdNc0hDLmlzii7VbYwDQYJKoZIhvcNAQEBBQAEggEAGAkl
# q6gCG/WiNuc6AYA4nRwX0xemk6I9V1E6F/wS80bijihO7f1q9oE9Um3Nas6F9LDI
# g4uFToVpFE2eQ9oBX09f5mq/P5y+VWxWrq7AuBWvprueCgArh+moZfVqCrIX/7hI
# Oib4ZFCPI2Sm+WHh5zqUEwscDdMaU6h1ioNlhMGbp8RnkXoD1yiAgZKqO+aoDge3
# it8qGty03kYVEB6Mq3cauzYb4aA1z+Hq1WS0SQfjDyPXcl+6Dw3enwRJcwD+wbbf
# n6ICtwciSk7xSkxI6JkfpR8K7FwrhIPctt/z4+eBOm40alVvMA0Q004MYotIJk2d
# qbDwpUUsRAt5s3HdsA==
